...
public class InternetUserLayoutController implements Initializable{
	...
	private void handleAccept()
	{
		...
		{
			mainApp.getSelectedTakeOverData().getInternetAcceptData().add(new InternetAcceptData(
	...
	private void handleSameUpper()
	{
		if(editMode)
			...
			setUpperData(mainApp.getSelectedTakeOverData().getInternetAcceptData().size() - 1);
	}
	...
	public void setMainApp(MainApp mainApp, Stage stage)
	{
		...
		if(mainApp.getSelectedTakeOverData().getInternetAcceptData().size() == 0)
	...
	public void setDefaultData(int index)
	{
		...
		if(index != -1)
		{
			this.curData = mainApp.getSelectedTakeOverData().getInternetAcceptData().get(index);
	...
	public void setUpperData(int index)
	{
		if(index != -1)
		{
			InternetAcceptData tmpData = mainApp.getSelectedTakeOverData().getInternetAcceptData().get(index);
